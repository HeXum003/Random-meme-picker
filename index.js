...
function showQuote() {
  ...
  author.textContent = 'Author- ' + randomQuote.author;
  clearAll();
...
function revealAnswers() {
  ...
  if(riddle && answer.hidden){
    answer.hidden = false;
      ...
      alert('The riddle is already reavealed')
